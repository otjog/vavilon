...
$('#customerMailModal').on('show.bs.modal', function (event) {
    ...
    let customerId = button.data('customerid'); // Extract info from data-* attributes
...
let modalCaller = document.getElementById('modal_caller');
if(modalCaller !== undefined && modalCaller !== null) {
    let modalId = modalCaller.dataset.modal;
    console.log(modalId);
    $('#'+modalId).modal('show');
}
